...
if(isset($_POST['order'])){
	...
	if(empty($errors)){
	$insertquery="INSERT INTO neededbooks(booktitle,bookauthor,firstname,lastname,email,phone) VALUES('{$booktitle}','{$bookauthor}','{$ffirstname}','{$fsurname}','{$femail}','{$fphone}')";
	...
	$message= Swift_Message::newInstance()
		->setSubject('Book requested')
		->setFrom(['admin@maaktaba.com' =>'Maaktaba'])
		->addTo('admins@maaktaba.com')
		->setBody('The following book has been requested'.' 
        '.'Booktitle:'.$booktitle.'
        '.'Book author:'.$bookauthor.'
        '.'User firstname:'.$ffirstname.'
        '.'User lastname:'.$fsurname.'
        '.'User email:'.$femail.'
        '.'User phone:'.$fphone);
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
							...
							<header class="major">
								<h2>User info</h2>
								<form method="post" action="cinformation.php">
