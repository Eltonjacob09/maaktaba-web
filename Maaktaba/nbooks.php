				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							...
							<li><a href="nbooks.php" class="active">Needed books</a></li>
					...
					<div id="main">
						...
						<!-- First Section -->
							<section id="first" class="main special">
								<header class="major">
									<h2>Needed books:(<?php echo $number;?>)</h2>
								</header>
						
									<ul class="features">
									<?php
										while($books=mysqli_fetch_array($runquery)) {
									...
									<li>
										...
										<p style="font-size:15px; margin-bottom:0;">
											Booktitle:<?php echo $books['booktitle'];?><br>
											Bookauthor<?php echo $books['bookauthor'];?><br>
											Cfirstname:<?php echo $books['firstname'];?><br>
											Clastname:<?php echo $books['lastname'];?><br>
											Cemail:<?php echo $books['email'];?><br>
											Cphone:<?php echo '0'.$books['phone'];?><br>
											
										</p>
									
										<a href="clear.php?id=<?php echo $books['bookid'];?>" class="button">Clear</a>
