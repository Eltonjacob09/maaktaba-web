...
if(isset($_POST['request'])) {
		...
		header('location:cinformation.php');
				...
				<!-- Main -->
					<div id="main">
						...
						<section id="second" class="main special">
							<header class="major">
							<p> Please provide us with information about the books</p>
								
																	

								<form method="post" action="neededbook.php">
									
									<label style="font-size:25px; margin-bottom:0;">Book Title</label>
									<input type="text" name="booktitle" required placeholder="Book title" style="width:50%; margin:auto; margin-bottom:5px;">
									<label style="font-size:25px; margin-bottom:0;">Book Author</label>
									<input type="text" name="bookauthor"  placeholder="Book Author" style="width:50%; margin:auto; margin-bottom:10px;">
